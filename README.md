...
Few Packages will already be intstalled:
Packages of Tensor flow, GitPython,Keras Preprocessing,XGboost,Scikit Learn,Streamlit,Pandas,Numpy,openCV is needed.
